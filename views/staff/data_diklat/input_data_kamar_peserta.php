    ...
    <?php include "../partial/header.php" ?>
      ...
      <div id="page-wrapper">          
       <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h3><br>Input Data Kamar Peserta</h3>
                </div>    
                <div class="row">
                    <div class="col-lg-7">
                        <form method="POST" action="proses_input_data_kamar.php">
                            <div class="form-grup"></div>
                            <div class="form-grup">
                                <label for="namaasrama">Nama Asrama</label>
                                <input type="namaasrama" class="form-control" id="namaasrama" name="namaasrama" placeholder="namaasrama">
                            </div>
                             <div class="form-grup">
                                <label for="nomorkamar">Nomor Kamar</label>
                                <input type="nomorkamar" class="form-control" id="nomorkamar" name="nomorkamar" placeholder="nomorkamar">
                            </div><br>
