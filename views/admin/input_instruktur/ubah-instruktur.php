                    ...
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="input_instruktur/proses_ubah_instruktur.php">
                            ...
                            <div class="form-grup">
                                ...
                                <input type="text" class="form-control tgllahir" id="tanggallahir" name="tanggallahir" placeholder="Tanggal Lahir" data-date-format="yyyy-mm-dd" value="<?php echo $instruktur_data['tgl_lahir'] ?>">
                            </div><br>
                            <div class="form-grup">
