    ...
    <div class="col-md-6">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="input_admin/proses_hapus_admin.php" method="POST">
                            <?php 

                                $id = $_GET["id"];

                                $sql = "SELECT nik, nama FROM tb_detail_admin WHERE id = '$id'";
                            ...
                            <p>
                                Apakah anda yakin ingin menghapus data admin dengan data berikut ini : ?
                            </p>
