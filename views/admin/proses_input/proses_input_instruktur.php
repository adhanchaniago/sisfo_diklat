<?php 
	...
	if ($proses){
		...
		$sql2 = "INSERT INTO tb_detail_instruktur (user_akun_id, nik, nama, tempat_lahir, tgl_lahir, alamat, nomor_hp) VALUES ('$userakun_id', '$nik','$nama', '$tempatlahir', '$tanggallahir', '$alamat', '$nohp')";
