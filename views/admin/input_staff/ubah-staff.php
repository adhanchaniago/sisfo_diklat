    ...
    <div class="col-md-6">
        <div class="panel panel-success">
            <div class="panel-heading">
                <h5><strong><i class="fa fa-address-card"></i>&nbsp;Ubah Data Staff</strong></h5>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php 
                            ...
                            $admin_sql = "SELECT * FROM tb_detail_staff WHERE id = '$id'";
                            $admin_proses = mysqli_query($conn, $admin_sql);
                            $admin_data = mysqli_fetch_assoc($admin_proses);

                        ?>  
                        <form method="POST" action="input_staff/proses_ubah_staff.php">
                            ...
                            <div class="form-grup">
                                ...
                                <input type="text" class="form-control datepicker" id="tanggallahir" name="tanggallahir" placeholder="Tanggal Lahir" data-date-format="yyyy-mm-dd" value="<?php echo $admin_data['tgl_lahir'] ?>">
                            </div><br>
                            <div class="form-grup">
                            ...
                            <div class="form-group">
                                ...
                                <a href="?page=lihat-staff" class="pull-right"><button type="button" class="btn btn-danger">Batal</button></a>
                            </div>
                        </form>
                    </div>
                </div>
