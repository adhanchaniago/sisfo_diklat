                    ...
                    <table class="table table-bordered table-hover my-datatable">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM tb_detail_staff";
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-success btn-xs dropdown-toggle" type="button" data-toggle="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="?page=ubah-staff&id=<?php echo $data['id'] ?>">Ubah Data</a></li>
                                                <li><a href="?page=hapus-staff&id=<?php echo $data['id'] ?>">Hapus Data</a></li>
                                            </ul>
                                        </div>
                                    </td>
