...
<head>
    ...
    <link href="assets/vendor/mamba/css/bootstrap.min.css" rel="stylesheet" media="screen">
    <link href="assets/vendor/mamba/css/style.css" rel="stylesheet" media="screen">
    <link href="assets/vendor/mamba/color/default.css" rel="stylesheet" media="screen">
    <script src="assets/vendor/mamba/js/modernizr.custom.js"></script>
        ...
        <div class="intro-text">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="brand">
                            <h1><a href="#">Pendidikan & Pelatihan</a></h1>
                            <div class="line-spacer"></div>
                            <p><span>PT. PEGADAIAN (PERSERO) PADANG</span></p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row mar-top30 ">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>2017 &copy; Pendidikan & Pelatihan PT. Pegadaian (Persero) Padang. All Rights Reserved</p>
                </div>
            </div>      
        </div>  
    </footer>
    ...
    <!-- js -->
    <script src="assets/vendor/mamba/js/jquery.js"></script>
    <script src="assets/vendor/mamba/js/bootstrap.min.js"></script>
    <script src="assets/vendor/mamba/js/jquery.smooth-scroll.min.js"></script>
    <script src="assets/vendor/mamba/js/jquery.dlmenu.js"></script>
    <script src="assets/vendor/mamba/js/wow.min.js"></script>
    <script src="assets/vendor/mamba/js/custom.js"></script>
    <script src="assets/vendor/mamba/contactform/contactform.js"></script>
